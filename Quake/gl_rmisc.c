...
void R_CreatePipelines()
{
	...
	CREATE_SHADER_MODULE(shadow_miss_ray);
	...
	rt_shader_stages[2].module = shadow_miss_ray_module;
	...
	vkDestroyShaderModule(vulkan_globals.device, shadow_miss_ray_module, NULL);
